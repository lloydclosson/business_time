This is a fork to allow multiple configurations. My use case is allowing each company in my program needs the ability to configure their own work start and end times, work days and holidays.
